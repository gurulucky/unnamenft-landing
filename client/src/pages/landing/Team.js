      ...
      <Box sx={{ mb: 5, textAlign: 'center' }}>
        <MotionInView variants={varFadeInDown}>
          ...
          <Typography
            ...
            paragraph
          >
            The   Club Team is comprised of real ns who’s knowledge spans a wide variety of disciplines (and vices).
          </Typography>
          <Typography
            variant='h6'
            paragraph
          >
            Our vision is of a diverse Club of  s who respect the ABC values and join together to genuinely support each other in all areas of life including mental and physical health, education, personal development, career, business, special interests, socially entertainment and enjoyment.  To this end, all our utility, including future utility, will be based upon our pursuit to the fulfilment of our vision.
          </Typography>
        </MotionInView>
      </Box>
