          ...
          <Box sx={{ margin: 'auto' }}>
            ...
            <motion.div variants={varFadeInRight}>
              ...
              <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
                 Bogan Club Pty Ltd (ACN 653 514 231) ("we", "us", “Company", or “ABC”) is committed to privacy protection.
              </Typography>
              <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
                ABC is the creator and owner of the  Bogan Club concept, design and all associated intellectual property (“IP”) including the domain name bogan.club.
              </Typography>
              <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
                At ABC and the bogan.club website ("Site"), we understand the importance of keeping personal information private and secure. This privacy policy ("Privacy Policy") describes generally how we manage personal information and safeguard privacy. If you would like more information, please do not hesitate to contact us.
              </Typography>
              <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
            ...
            <motion.div variants={varFadeInRight}>
              ...
              <Typography variant='h5' color='primary' paragraph={true}>
                THE N PRIVACY PRINCIPLES
              </Typography>
              <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
                We will treat all personal information in accordance with any and all obligations that are binding upon us under the Privacy Act 1988 (Cth) (“Privacy Act”). The Privacy Act lays down 13 key principles in relation to the collection and treatment of personal information, which are called the “n Privacy Principles”.
              </Typography>
              <Typography variant='h5' color='primary' paragraph={true}>
            ...
            <motion.div variants={varFadeInRight}>
              ...
              <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
                If you would like more information about the way we manage personal information that we hold about you, or are concerned that we may have breached your privacy, please contact us by email at admin@bogan.club or otherwise you may write to us at our postal address, being <span style={{ fontWeight: 'bold' }}>PO Box 2026, Clovelly West, NSW, 2031, </span> .
              </Typography>
            </motion.div>
            ...
            <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
              In most cases, you may have access to personal information that we hold about you. We will handle requests for access to your personal information in accordance with the n Privacy Principles. All requests for access to your personal information must be directed to the Privacy Officer by email or by writing to us at our postal address, being <span style={{ fontWeight: 'bold' }}>PO Box 2026, Clovelly West, NSW, 2031, </span>. We will deal with all requests for access to personal information as quickly as possible. Requests for a large amount of information, or information that is not currently in use, may require further time before a response can be given. We may charge you a fee for access if a cost is incurred by us in order to retrieve your information, but in no case will we charge you a fee for your application for access.
            </Typography>
            <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
            ...
            <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
              From time to time, it may be necessary for us to revise this Privacy Policy. Any changes will be in accordance with any applicable requirements under the Privacy Act and the n Privacy Principles. We may notify you about changes to this Privacy Policy by posting an updated version on this Site.
            </Typography>
            <Typography paragraph={true} sx={{ color: 'text.secondary' }}>
              If you require any further information about the Privacy Act and the n Privacy Principles, you can visit the Federal Privacy Commissioner’s website.(see <a href='https://www.privacy.gov.au' target='_blank'>www.privacy.gov.au</a>).
            </Typography>
